          ...
          <div className="absolute inset-0 animate-spin-slow">
            ...
            >
              {Array.from({ length: 12 }).map((_, i) => {
                ...
                return (
                  <div key={i} className="absolute rounded-2xl overflow-hidden shadow-sm opacity-40"
                    style={{
          ...
          <div className="absolute inset-0 animate-spin-slow-reverse">
            ...
            >
              {Array.from({ length: 8 }).map((_, i) => {
                ...
                return (
                  <div key={i} className="absolute rounded-xl overflow-hidden shadow-md opacity-60"
                    style={{
          ...
          <div className="absolute inset-0 animate-spin-slow">
            ...
            >
              {Array.from({ length: 5 }).map((_, i) => {
                ...
                return (
                  <div key={i} className="absolute rounded-lg overflow-hidden shadow-lg opacity-90"
                    style={{
