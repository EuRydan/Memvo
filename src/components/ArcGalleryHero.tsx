...
export const ArcGalleryHero: React.FC<ArcGalleryHeroProps> = ({
  ...
  return (
    <section className={`relative overflow-hidden bg-transparent pt-32 pb-16 flex flex-col ${className}`}>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-32 md:-mt-48 lg:-mt-52">
        <div className="text-center max-w-3xl px-6 opacity-0 animate-fade-in" style={{ animationDelay: '800ms', animationFillMode: 'forwards' }}>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-[-0.02em] text-[#0a0a0a] leading-tight" style={{ fontFamily: 'var(--font-raleway), Georgia, serif' }}>
            Indique tecnologia, <br/><span className="text-[#676f7b]">gere memórias.</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-[#676f7b] max-w-2xl mx-auto">
            Apresente a Memvo aos seus clientes e ganhe <strong className="text-[#0a0a0a]">25% de comissão</strong> por cada evento ativado. A ferramenta perfeita para cerimonialistas, fotógrafos e assessores.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/parceiros/cadastro" className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#0a0a0a] text-white font-bold hover:bg-black/80 transition-all duration-200 shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5">
              Quero ser parceiro
            </Link>
            <a href="#how-it-works" className="w-full sm:w-auto px-8 py-4 rounded-full border border-gray-300 hover:bg-gray-100 font-semibold text-[#0a0a0a] transition-all duration-200">
              Como Funciona
            </a>
          </div>
        </div>
