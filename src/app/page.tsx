...
import { ArrowRight, QrCode, Zap, Target, Download, Unlock, Smartphone } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#fafafa] overflow-clip">
      ...
      <section className="py-16 w-full max-w-6xl mx-auto overflow-hidden">
        ...
        <ServiceCarousel services={[
          { number: '01', icon: QrCode, title: 'Link & QR Code', description: 'Compartilhe por qualquer canal', gradient: 'from-[#f4c5a8] to-[#e8b898]' },
          { number: '02', icon: Zap, title: 'Tempo real', description: 'Fotos aparecem instantaneamente', gradient: 'from-[#c8b8e0] to-[#b8a8d0]' },
          { number: '03', icon: Target, title: 'Desafios', description: 'Missões para engajar convidados', gradient: 'from-[#b8d4f0] to-[#a8c4e0]' },
          { number: '04', icon: Download, title: 'Download', description: 'Baixe todas as fotos em HD', gradient: 'from-[#f4c5a8]/80 to-[#e8b898]/80' },
          { number: '05', icon: Unlock, title: 'Sem login', description: 'Convidados enviam sem cadastro', gradient: 'from-[#c8b8e0]/80 to-[#b8a8d0]/80' },
          { number: '06', icon: Smartphone, title: 'Mobile first', description: 'Funciona em qualquer celular', gradient: 'from-[#b8d4f0]/80 to-[#a8c4e0]/80' },
        ]} />
      </section>
